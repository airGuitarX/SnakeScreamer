// Frank Poth 11/20/2017 — adapted for SSnake (purple theme)
...
(function() {
  ...
  display = {
    ...
    output:document.querySelector("#score"),// The score element.
